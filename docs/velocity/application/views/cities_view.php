  ...
  <div class="bg-slider-wrapper">
    ...
    <section class="promo section section-on-bg">
        <div class="container text-center">                
            <h2 class="title">Redefining Air Travel</h2>
            <p class="intro">Velocity is a private aviation service based in the bay area<br /> Tap a button and be in the air minutes later</p>
            <p><a class="btn btn-cta btn-cta-primary" href="signup.html">Join Velocity Free</a> <a class="btn btn-cta btn-cta-primary" href="signup.html">See How It Works</a></p>   
