...
$result = mysqli_query("SELECT * FROM $main_table");
...
$result = mysqli_query("SELECT * FROM $folder_table");
...
$result = mysqli_query("SELECT * FROM $user_table");
...
$result = mysqli_query("SELECT * FROM $id_table");
