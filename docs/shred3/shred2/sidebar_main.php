...
//sqlStart();
	...
	$sql = "SELECT * FROM $folder_table WHERE user=$uid ORDER BY ID DESC";
	...
	if ($result)
	{
		while($row = mysql_fetch_array($result))
                	...
                	echo"
                		<div class=\"panel-group\" id=\"accordion\">
                        	<div class=\"panel panel-default\">
                                ...
                                <h4 class=\"panel-title\"><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse" . $count . "\"><span class=\"glyphicon glyphicon-chevron-down fr\"></span></a><a href=\"http://howlix.com/shred2/folder.php?folder=" . $folder . "&fid=" . $fid . "&squawk=" . $Sfid . "\"> " . $folder . "</a></h4>
                                </div>
			...
			// SESSION
				...
				<li><a href=\"http://howlix.com/shred2/delete.php\" title=\"Delete This Folder\" class=\"glyphicon glyphicon-remove-circle\"></a></li>
				</ul>
                         	</div>
                                </div>
                        	</div>  
