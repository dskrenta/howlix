...
main = function() {
  ...
  fallsounds = function (sounds) {
    var sounds = ["http://www.sesameworkshop.org/flappybert/assets/sounds/bert-ernie2.mp3", "http://www.sesameworkshop.org/flappybert/assets/sounds/bert-ernie.mp3"];
  ...
  if (myAudio.canPlayType('audio/ogg')) {
    assets = {
      ...
      image: {
        tubeTop: ["http://www.sesameworkshop.org/flappybert/assets/images/tubeUP.png"],
        tubeBottom: ["http://www.sesameworkshop.org/flappybert/assets/images/tubeDOWN.png"],
        ground: ["http://www.sesameworkshop.org/flappybert/assets/images/pavement.png"],
        streetSign: ["http://www.sesameworkshop.org/flappybert/assets/images/street-sign.png"],
        bg: ["http://www.sesameworkshop.org/flappybert/assets/images/bg.png"]
      },
      audio: {
          flap: ["http://www.sesameworkshop.org/flappybert/assets/sounds/wing.ogg"],
          laugh: ["http://www.sesameworkshop.org/flappybert/assets/sounds/bert-laugh.ogg"],
          fall: ["http://www.sesameworkshop.org/flappybert/assets/sounds/bert-ernie.ogg"],
          swoosh: ["http://www.sesameworkshop.org/flappybert/assets/sounds/swoosh.ogg"]
      }
    };
  } else {
      assets = {
        spritesheet: {
          bird: ["http://www.sesameworkshop.org/flappybert/assets/images/bert-hands.png", 30, 76]
        },
        image: {
          tubeTop: ["http://www.sesameworkshop.org/flappybert/assets/images/tubeUP.png"],
          tubeBottom: ["http://www.sesameworkshop.org/flappybert/assets/images/tubeDOWN.png"],
        ...
        audio: {
          flap: ["http://www.sesameworkshop.org/flappybert/assets/sounds/wing.mp3"],
          laugh: ["http://www.sesameworkshop.org/flappybert/assets/sounds/bert-laugh.mp3"],
          fall: ["http://www.sesameworkshop.org/flappybert/assets/sounds/bert-ernie.mp3"],
          swoosh: ["http://www.sesameworkshop.org/flappybert/assets/sounds/swoosh.mp3"]
        }
      };
  }
