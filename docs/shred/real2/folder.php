...
$tbl_file="shredstore4"; // Table name 
$tbl_folder="shredfold"; // Table name
...
?>
	...
	<div class="col-md-9" id="mainCol">
		...
		<div id="folderButtonsSm">
			<a href="#" data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-plus-sign mr5"></span> Add/Recommend Content</a>
			<a href="#" data-toggle="modal" data-target=".bs-example-modal-sm"><span class="glyphicon glyphicon-share-alt mr5"></span> Share This Folder</a>
		</div>
...
// Retrive data from database 
//$sql = "SELECT * FROM $tbl_name";
$sql="SELECT * FROM $tbl_name WHERE folder='$folder_name' ORDER BY ID DESC";
$result = mysql_query($sql) or die(mysql_error());
