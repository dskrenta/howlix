			...
			<div class=\"panel panel-default\">
				...
				<div id=\"collapse" . $count . "\" class=\"panel-collapse collapse\">
					<div class=\"panel-body\">
						...
						if($result)
						{
							while($row = mysql_fetch_array($out))
								...
								echo"
									...
									<a href=\"http://howlix.com/shred/real/post.php?id=" . $shred_id . "\">" . $shred_title . "</a>
									</li>
								";
							}
						}
						...
						<ul class=\"folderTray\">
							<li><a href=\"http://howlix.com/shred/real2/addContent.php\"  data-toggle=\"modal\" title=\"Add Content\" class=\"glyphicon glyphicon-plus\"></a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Content To <?php echo $folders[1]; ?></h4>
      </div>
      <div class="modal-body">
