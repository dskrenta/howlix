...
// This is called with the results from from FB.getLoginStatus().
  function statusChangeCallback(response) {
	...
	window.location.assign("http://howlix.com/shred/real2/shredfb2")
    } else {
				...
				<?php 
					...
					{ 
						...
						if ($out)
						{
							...
							//echo"<li>". $user_id ."</li><br />";
							//echo"<li>". $user_date ."</li><br />";
							//echo"<li>". $user_uid ."</li><br />";
							echo"<li><a href=\"http://howlix.com/shred/real2/user.php\">". $user_name ."</a></li>";
							//echo"<li>". $user_img ."</li><br />";	
							//echo"<li><a href=\"index.html\">" . $user_name . "</a></li>";
						}
						...
						//echo"<li><a href=\"index.html\">" . $name . "</a></li>"; 
					}
					else
					{
						// Todo redirect to original login
						// echo"<li><a href=\"index.html\"> Guest</a></li>";
						//header("Location: http://howlix.com/shred/real2/shredfb2.php");
						// Add JS Redirect
						echo"<script>window.location.assign(\"http://howlix.com/shred/real2/shredfb2.php\")</script>";
					}
				?>		
				<li><a href="http://howlix.com/shred/real2/shredfb2.php" onclick="logout()">Logout</a></li>
			</ul>
	    	</span>
		</div>
...
<div id="wrapper" class="col-md-12 container-fluid">
	<div class="col-md-3" id="leftCol">
		...
		<h3><span style="left:auto !important;right:0;"><a href="http://howlix.com/shred/real/addFolder.php" class="glyphicon glyphicon glyphicon-plus-sign" rel="tooltip" data-placement="left" title="add a new folder"></a></span>David's Folders</h3>
...
?>
	...
	<div class="col-md-9" id="mainCol">
		...
		<div class="tabLatest mb15">
			<a href="#"><img src="http://www.songsterr.com/WebObjects/Songsterr.woa/Contents/WebServerResources/daaacd66f7fa700bf7a7b34e32c618b3/v1/favicon.ico" class="fl mr15 pic" /></a>
			<div class="result">
				<span class="glyphicon glyphicon-plus fr" data-placement="right" data-toggle="popover" data-content="<strong>Add to my:</strong><br /><a href='user.html?submit=yes'>Guitar&nbsp;Tabs</a><br /><a href='user.html?submit=yes'>Wish&nbsp;List</a><br /><a href='user.html?submit=yes'>Recipes</a>"></span>
				<h3><a href="#" class="black title">Time</a></h3>
				<p><small>added 5 days ago from <a href="http://www.songsterr.com/a/wsa/pink-floyd-time-tab-s15873t4" target="_new">songsterr.com</a> &bull; <a href="#">music</a> &bull; <a href="#">2 comments</a></small></p>
			</div>
		</div>
		<hr />
		-->
...
// MySQL
$stuff = "SELECT * FROM $tbl_name WHERE user=$get_user";
$run = mysql_query($stuff) or die(mysql_error());

if ($run)
{
	$row = mysql_fetch_array($out);
      	$userOut_id = $row['ID'];
 	$userOut_date = $row['date'];
    	$userout_uid = $row['uid'];
      	$userOut_name = $row['user'];
       	$userOut_img = $row['imgUrl'];
...
//$sql="SELECT * FROM $tbl_name WHERE user='$user_uid' ORDER BY ID DESC";
$sql="SELECT * FROM $tbl_name WHERE user=$userout_id ORDER BY ID DESC";
...
if($result)
{
		...
		echo"
			<!-- Start Shred-->
                 	...
                 	<div class=\"result\">
                  	<h3><a href=\"http://howlix.com/shred/real2/post.php?id=$id\" class=\"black title\"> " . $title . " </a></h3> <!--Title-->
                    	<p class=\"snippet\"> " . $snippet . " </p>
			<p><small>added by " . $user . " at " . $date . " &bull; <a href=\" " . $url . " \" target=\"_new\"> " . $url . " </a> &bull; <a href=\"http://howlix.com/shred/real2/folder.php?folder=" . $folder . "\"> " . $folder . " </a> </small></p>
                      	</div>
                    	</div>
                      	<!-- End Shred -->
                      	<hr />
