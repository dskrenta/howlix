					...
					<div class=\"panel-body\">
						<ul id=\"tabList\">
							<li>
								...
								<a href=\"stairway.html\">Stairway To Heaven</a>
							</li>
						</ul>
					</div>
				</div>
...
//</div>
		...
		//		<a href=\"#\"><img src=\"http://google.com/s2/favicons?domain= " . $url . " \" class=\"fl mr15 pic\" /></a>
		//		<div class=\"result\">
		//		<h3><a href=\"http://howlix.com/shred/real/post.php?id=$id\" class=\"black title\"> " . $title . " </a></h3> <!--Title-->
		//		<p><small>added by " . $user . " at " . $date . " &bull; <a href=\" " . $url . " \" target=\"_new\"> " . $url . " </a> &bull; <a href=\"http://howlix.com/shred/real/folder.php?\"> " . $folder . " </a> &bull; <a href=\"#\">2 comments</a> </small></p>
		//		</div>
		//		</div>
		//		<!-- End Shred -->
		//		<hr />
		...
		echo"
			<!-- Start Shred-->
                      	<div class=\"tabLatest mb15\">
                      	<!--<a href=\"#\"><img src=\"http://static.ddmcdn.com/en-us/skins/hsw/misc/favicon.ico\" class=\"fl mr15 pic\" /></a>--> <!-- Placholder! Icon -->
                     	<a href=\"#\"><img src=\"http://google.com/s2/favicons?domain=www." . $str . " \" class=\"fl mr15 pic\" /></a>
                 	<div class=\"result\">
                  	<h3><a href=\"http://howlix.com/shred/real/post.php?id=$id\" class=\"black title\"> " . $title . " </a></h3> <!--Title-->
