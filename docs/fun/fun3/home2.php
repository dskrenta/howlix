...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>Fun.</h1>
	<button type="button" class="btn btn-danger" data-toggle="modal" onClick='document.getElementById("iframeURL").src="http://howlix.com/fun/fun3/file.html";' data-target="#myUploadModal">Upload</button>
      </div>
...
$sql="SELECT * FROM $tbl_name ORDER BY numid DESC";
