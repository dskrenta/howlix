...
<html lang="en">
  <head>
   ...
   <style>
      .plinks {color:black; text-decoration: none;}      /* Post link */
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="container">
	  ...
	  <li><a href="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fhowlix.com%2Ffun%2Ffun5&width&layout=button_count&action=like&show_faces=true&share=false&height=21" class="btn btn-primary">Like</a></li>
          <li><a href="#" class="btn btn-info">Tweet</a></li>
          <li><a href="#" class="btn btn-danger">Upload</a></li>
        </ul>
        <a href="http://howlix.com/fun/fun5"><h3 class="text-muted">Fun.</h3></a>
      </div>

      <div class="jumbotron">
        <h1>Fun.</h1>
	<button type="button" class="btn btn-danger" data-toggle="modal" onClick='document.getElementById("iframeURL").src="http://howlix.com/fun/fun5/file.html";' data-target="#myUploadModal">Upload</button>
      </div>
...
if($result)
{
	...
	while($row = mysql_fetch_array($result)) 
	{
		...
		{		
			echo " 
				<a class=\"plinks\" href=\"http://howlix.com/fun/fun5/post.php?id= " . $id . " \"><h1> " . $title . " </h1></a>
        			<a href=\"http://howlix.com/fun/fun5/post.php?id= " . $id . " \"><img width=\"100%\" src=\" " .  $url . " \"></img></a>
        			<p>
        			<div class=\"btn-group\">
        			...
        			<a href=\"http://howlix.com/fun/fun5/post.php?id= " . $id . " \" class=\"btn btn-default btn-lg\"><i class=\"glyphicon glyphicon-fullscreen\"></i></a>
        			</div>
