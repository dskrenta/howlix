...
?>
        ...
        <div class="col-md-9" id="mainCol">
			...
			<strong>Content</strong> &bull;
			<a href="http://howlix.com/shred2/main_list.php">List</a> &bull;
			<!-- <form method="post" action="mainForm.php"> -->
			<select name="type">
		...
		while($row = mysql_fetch_array($result))
			...
			*/
			...
			else
			{
				// Own == No
				echo "
					<a href=\"http://howlix.com/shred2/recommend.php?folder=" . $folder . "\"><button type=\"button\" class=\"btn btn-default btn-xs\">Suggest</button></a>
					</td><td style=\"padding: 0px\">
...
if (isset($_GET["load"]))
{
	...
	$new_page = $load + 10;
	echo "
		<a href=\"http://howlix.com/shred2/main.php?load=" . $new_page . "\"><button type=\"button\" class=\"btn btn-primary btn-lg btn-block\">Load More</button></a>
	";
}
...
{
	echo "
		<a href=\"http://howlix.com/shred2/main.php?load=20\"><button type=\"button\" class=\"btn btn-primary btn-lg btn-block\">Load More</button></a>
	";
}
?>
</center>
