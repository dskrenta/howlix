...
print"
<a href=\"$url\"><img src=\"$url\" width=\"200px\" height=\"200px\" alt=\"\" onerror=\"this.style.display=\'none\'\"></a>
";
}
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="#"><span style="color:white">Harvix Image Search</span></a>
...
<button class="btn dropdown-toggle" data-toggle="dropdown">Menu <span class="caret"></span></button>
                <ul class="dropdown-menu">
                  <li><a href="http://howlix.com/mst3k.cgi?$query">Everything</a></li>
                  <li><a href="http://howlix.com/mst3k.cgi?$query">Web</a></li>
                  <li><a href="http://howlix.com/images.cgi?$query">Images</a></li>
		  <li><a href="http://howlix.com/videos.cgi?$query">Videos</a></li>
                  <li class="divider"></li>
                  <li><a href="#">Share your results</a></li>
                </ul>
</li>
            </ul>
          </div><!--/.nav-collapse -->
