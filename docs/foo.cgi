...
print"<p>$wiki_page</p>";
print"<p>$wiki_url</p>";
print"<a href=\"#myModalwiki\" class=\"btn btn-primary btn-large\" data-toggle=\"modal\">Read More &raquo;</a>  <a href=\"#myModal1\" role=\"button\" class=\"btn btn-primary btn-large\" data-toggle=\"modal\">Share</a></p>";
print" 
...
foreach my $res ( @results )
{
	...
	print"<li><a href=\"$url\"><h4><u>$res->{title}</u></h4><span style=\"color:black\"><p>$snippet</p>
	<p>$url</p></span>
	</a></li>
	<li class=\"divider\"></li>
	";
