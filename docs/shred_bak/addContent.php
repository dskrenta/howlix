...
<div class="col-md-9" id="mainCol">
		...
		<h2>Add Content To <?php
                        ...
                        $folder_get = $_GET["folder"];
                        echo $folder_get;
                ?> <span style="color:red">(DEPRECATED)</span></h2>
	...
	<p><span style="color:red">(DEPRECATED) NOTES:</span></p>
        <p><span style="color:red">To be replaced with tab feature and modal for all add content buttons</span></p>
...
<div class="col-md-9 create-folder" id="mainCol">
		...
		<h2>Add Content To <?php echo $folder_get; ?></h2>

		<form method="post" action="contentNewv2.php">
		...
		<div class="tab-content">
			...
			<div class="tab-pane fade" id="createImg">
				<div class="modal-body">
					<h4>Add an image to your folder:</h4>
			...
			<div class="tab-pane fade" id="createVid">
				<div class="modal-body">
					<h4>Add a Youtube or Vimeo URL or ID:</strong></h4>
