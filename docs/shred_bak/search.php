...
//sqlStart();
	...
	$sql = "SELECT * FROM $main_table WHERE uid='$uid' AND title='$query' ORDER BY ID DESC";
...
<br /><br />
<h4>Results From All Of ShredFeed:</h4>

<?php

$sql = "SELECT * FROM $main_table WHERE title='$query' ORDER BY ID DESC";
        $result = mysql_query($sql) or die(mysql_error());
