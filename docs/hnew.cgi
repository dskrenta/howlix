...
div.hello2{font-size:40px; font-family:  Chalkduster, sans-serif; font-size: normal; line-height: normal;}
...
<div class="new">
<table><tr><td>
<div class="hello2"><a href="index.html"><strong><span style="color:black;">How</span><span style=color:red;">lix</span></strong></a></div>
</td><td>

<form id="searchForm" name="searchForm" action="http://howlix.com/hnew.cgi" onsubmit="submitted('h'); return false" class="form-wrapper cf">
<input id="searchBox" autofocus="autofocus" autocomplete="off" type="text" spellcheck="false" name="q" placeholder=" showing results for $query" required />
