...
my $count = 0;
    ...
    my $result = $agent->search(($query), limit => 20);

    while (my $image = $result->next()) {
        my $url = $image->content_url();
print"
<a href=\"#myimages$count\"  data-toggle=\"modal\"><img src=\"$url\" width=\"200px\" height=\"200px\" alt=\"\" class=\"img-polaroid\" onerror=\"this.style.display=\'none\'\"></a>
";
print" 
  <div id=\"myimages$count\" class=\"modal hide fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myNotesLabel\" aria-hidden=\"true\">
  <div class=\"modal-header\">
    <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>
    <h3 id=\"myNotesLabel\">Images - $query</h3>
  </div>
  <div class=\"modal-body\">

<a href=\"$url\" target=\"_blank\"><img src=\"$url\" height=\"80%\" alt=\"\" class=\"img-polaroid\" onerro
r=\"this.style.display=\'none\'\"></a>
  </div>
