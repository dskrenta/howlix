...
//$html = file_get_html('https://www.youtube.com/playlist?list=PLrEnWoR732-AKYdZyzAnuf-MnPiw7rT4Q');
$html = file_get_html('https://www.youtube.com/playlist?list=PLrEnWoR732-BHrPp_Pm8_VleD68f9s14-');
...
foreach($html->find('a') as $element)
{
	...
	{ 
		...
		$ogitle = urlencode(mysql_real_escape_string($ogtitle));
		$ogdescription = urlencode(mysql_real_escape_string($ogdescription));
