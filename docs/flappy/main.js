...
function preload() {
    var assets = {
        spritesheet: {
            birdie: ['http://howlix.com/flappy/birdie.png', 24, 24],
            clouds: ['http://howlix.com/flappy/clouds.png', 128, 64]
        },
        image: {
            finger: ['http://howlix.com/flappy/finger.png'],
            fence: ['http://howlix.com/flappy/fence.png']
        },
        audio: {
            flap: ['http://howlix.com/flappy/flap.wav'],
            score: ['http://howlix.com/flappy/score.wav'],
            hurt: ['http://howlix.com/flappy/hurt.wav']
        }
    };
